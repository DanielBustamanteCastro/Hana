$(document).ready(function(){
    ...
    $(".Modern-Slider").slick({
        ...
        fade:true,
        draggable:false,
        prevArrow:'<button class="PrevArrow"><img src="../../images/slider/flecha.png" class="flecha"> <span class="Thumbnail"></span></button>',
        nextArrow:'<button class="NextArrow"><img src="../../images/slider/flecha2.png" class="flecha"> <span class="Thumbnail"></span></button>', 
