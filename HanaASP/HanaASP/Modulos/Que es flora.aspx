<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/Menu.master" AutoEventWireup="true" CodeBehind="Que es flora.aspx.cs" Inherits="HanaASP.Modulos.Que_es_ave" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
    <h1>¿QU&Eacute; ES FLORA?</h1>
                <p>
                ...
                <h2>Tratados sobre flora</h2>
                <p>Tradicionalmente, las floras son tratadas en libros, pero en la actualidad se publican en CD-ROM o páginas web. La zona que cubre una flora puede estar definida tanto geográfica como políticamente. Normalmente las floras requieren conocimientos botánicos especializados para poder utilizarlas con eficacia.Una flora contiene con frecuencia claves de diagnóstico. Estas son claves dicotómicas que requieren el examen repetido de una planta por parte del usuario para decidir cual de las dos alternativas dadas se ajusta con más exactitud a la planta.</p>
           </div>
</asp:Content>
