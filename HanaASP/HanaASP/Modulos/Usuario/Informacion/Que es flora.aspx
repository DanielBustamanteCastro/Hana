<%@ Page Title="¿Qué es flora?" Language="C#" MasterPageFile="~/Modulos/MenuUsuario.master" AutoEventWireup="true" CodeBehind="Que es flora.aspx.cs" Inherits="HanaASP.Modulos.Usuario.Informacion.Que_es_flora" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="contInfo">
            ...
            <div class="itemInfo">
                <div class="subTitleInfo">Tratados sobre flora</div>
                <div class="descInfo">Tradicionalmente, las floras son tratadas en libros, pero en la actualidad se publican en CD-ROM o páginas web. La zona que cubre una flora puede estar definida tanto geográfica como políticamente. Normalmente las floras requieren conocimientos botánicos especializados para poder utilizarlas con eficacia.Una flora contiene con frecuencia claves de diagnóstico. Estas son claves dicotómicas que requieren el examen repetido de una planta por parte del usuario para decidir cual de las dos alternativas dadas se ajusta con más exactitud a la planta.</div>
            </div>
        </div>
    </div>
