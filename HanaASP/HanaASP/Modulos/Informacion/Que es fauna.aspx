<%@ Page Title="¿Qué es fauna?" Language="C#" MasterPageFile="~/Modulos/Menu.master" AutoEventWireup="true" CodeBehind="Que es fauna.aspx.cs" Inherits="HanaASP.Modulos.Informacion.Que_es_fauna" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"><link href="../../Style/informacion.css" rel="stylesheet" />
