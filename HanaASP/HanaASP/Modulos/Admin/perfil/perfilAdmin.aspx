<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/MenuAdmin.master" AutoEventWireup="true" CodeBehind="perfilAdmin.aspx.cs" Inherits="HanaASP.Modulos.Admin.perfil.perfilAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="contPerfil">
        <div class="contImage">
            <a href="../../indexAdmin.aspx"><img src="../../../images/Logo.png" /></a>
            <div class="buttons">
                <a class="mover" href="../../indexAdmin.aspx">Ir a inicio</a>
        ...
        <div class="contData">
            ...
            <div class="itemPerfil">
                <label class="rol">Administrador</label>
            </div>
            <div class="itemPerfil">
                <label>Medellín</label>
            </div>
            <div class="itemPerfil img" tooltip="Modificar" flow="down">
                <a href="modificarPerfilAdmin.aspx"><img src="../../../images/settings.png" /></a>
            </div>
        </div>
    </div>
